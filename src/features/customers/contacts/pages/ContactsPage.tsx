...
import { GlobalContactDialog } from '@/features/customers/contacts/components/GlobalContactDialog'
import { useContacts } from '@/features/customers/contacts/hooks/useContacts'
...
export default function ContactsPage() {
  ...
  const hasContacts = pagination ? pagination.total > 0 : contacts.length > 0
      ...
      <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-muted-foreground">
            Manage contacts across all customers.
          </p>
        </div>
